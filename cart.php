...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
        <a class="navbar-brand fw-bold" href="./index.php">Digital <span class="text-danger">Domain</span></a>
                    ...
                    <table class="table table-bordered table-hover table-striped table-group-divider text-center">
                        ...
                        ?>
                                    ...
                                    <tr class="d-flex flex-column d-md-table-row ">
                                        ...
                                        <td>
                                            <input type="number" value="<?php echo $product_quantity; ?>" class="form-control w-50 mx-auto" min="1" name="qty_<?php echo $product_id; ?>">
                                        </td>
                                        <?php
                                        // $total_price += $product_values * $product_quantity;
